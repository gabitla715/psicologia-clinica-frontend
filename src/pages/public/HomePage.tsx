...
export function HomePage() {
  return (
    <div className="bg-white">
      ...
      {/* Hero */}
      <section className="border-b border-slate-100 bg-sage-50">
      ...
      <section id="quienes-somos" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <p className="text-xs font-semibold uppercase tracking-wide text-sage-700">Quiénes somos</p>
      ...
      <section id="servicios" className="border-y border-slate-100 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <p className="text-xs font-semibold uppercase tracking-wide text-sage-700">Nuestros servicios</p>
      ...
      <section id="ubicacion" className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <p className="text-xs font-semibold uppercase tracking-wide text-sage-700">Ubicación</p>
        <h2 className="mt-2 text-2xl font-semibold text-slate-900">Dónde encontrarnos</h2>

        <div className="mt-6 grid gap-6 sm:grid-cols-3">
          <div className="sm:col-span-1">
            <div className="flex items-start gap-3 rounded-xl border border-slate-200 p-4">
              <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-sage-700" />
              <div>
      ...
      <section id="contacto" className="border-t border-slate-100 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <p className="text-xs font-semibold uppercase tracking-wide text-sage-700">Contáctanos</p>
...
function ServicioCard({ icono, titulo, descripcion, servicio }: ServicioCardProps) {
  return (
    <div className="flex flex-col rounded-xl border border-slate-200 bg-white p-6">
      <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-sage-100 text-sage-700">
        {icono}
      </div>
      ...
      <Link
        ...
        className="mt-5 inline-flex items-center justify-center rounded-lg bg-slate-800 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-slate-700"
      >
        Solicitar atención
      </Link>
    </div>
